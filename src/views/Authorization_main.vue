  ...
  <div class="bg-[#f9fafc]">
    <div class="min-h-screen bg-img">
      ...
      <div class="flex justify-center pt-[40px]">
        <div class="bg-white px-[40px] py-[25px] rounded-[3px] box_sh">
          <div class="w-[320px] SpaceGroteskB">
            <h3 class="font-bold text-[#5e6c84] text-center mb-[25px]">Log in to Trello</h3>
            <div class="flex flex-col RobotoL">
              ...
              <button @click="login"
                ...
                <span class="text-white font-bold SpaceGroteskB">Login</span>
              </button>
            </div>
          </div>
          <p class="font-extralight text-[#4d4d4d] text-center py-[16px] RobotoL">OR</p>
          <div class="w-[320px] mt-[25px]">
            <h3 class="font-bold text-[#5e6c84] text-center mb-[25px] SpaceGroteskB">Sign up for Trello</h3>
            <div class="flex flex-col RobotoL">
              ...
              <button @click="sign_up"
                      class="bg-[#0066ff] hover:bg-[#003f9e] rounded-[5px] py-[8px]"><span
                  class="text-white font-bold SpaceGroteskB">Sing up</span>
              </button>
            </div>
          </div>
        </div>
